"""
This module enable us to process text using natural language processing to extract known - i.e. nouns (person, place, thing)
It uses Spacy to extract entites based on a pre-build model.
"""
